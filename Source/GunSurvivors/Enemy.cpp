...
void AEnemy::Die()
{
	...
	// Set the flipbook source to the dead flipbook
	PaperFlipbookComponent->SetFlipbook(DeadFlipbook);

	// Set the translucent sory priority to -5
	PaperFlipbookComponent->SetTranslucentSortPriority(-5);
